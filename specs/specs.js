...
describe ("Game", function() {
  ...
  it("will return true if game is won, false if game is still in play", function() {
    var testGame = new Game ();
    testGame.correctCounter = 5;
    expect(testGame.isGameWon()).to.equal(true);
  });
  it("will return false if game is still in play", function() {
    var testGame = new Game ();
    testGame.correctCounter = 3;
    expect(testGame.isGameWon()).to.equal(false);
  });
});
